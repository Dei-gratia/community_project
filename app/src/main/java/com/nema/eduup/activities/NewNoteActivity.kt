...
class NewNoteActivity : BaseActivity(), View.OnClickListener {
    ...
    private fun saveNote() {
        ...
        Toast.makeText(this, "New Note $noteSubject, $noteTitle, $noteDescription, $noteBody", Toast.LENGTH_SHORT).show()
    ...
    private fun uploadNote() {
        ...
        resultIntent.putExtra(AppConstants.NEW_NOTE, newNote)
