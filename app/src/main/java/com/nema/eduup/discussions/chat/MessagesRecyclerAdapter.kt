...
class MessagesRecyclerAdapter(private val context: Context) :
    ...
    inner class TextMessageViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val txtMessageText: TextView = itemView.findViewById(R.id.txtMessageText)
        val txtMessageTime: TextView = itemView.findViewById(R.id.txtMessageTime)
    ...
    inner class ImageMessageViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val txtSenderName: TextView = itemView.findViewById(R.id.txtSenderName)
        val imgMessageFile: ImageView = itemView.findViewById(R.id.imgMessageImage)
        val txtMessageTime: TextView = itemView.findViewById(R.id.txtMessageTime)
        val rlMessage: RelativeLayout = itemView.findViewById(R.id.rlMessage)
    }

    inner class FileMessageViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val imgMessageFileType: ImageView = itemView.findViewById(R.id.imgMessageFileType)
        val txtFileName: TextView = itemView.findViewById(R.id.tv_file_name)
        val txtMessageTime: TextView = itemView.findViewById(R.id.txtMessageTime)
        val txtSenderName: TextView = itemView.findViewById(R.id.txtSenderName)
        val rlMessage: RelativeLayout = itemView.findViewById(R.id.rlMessage)
    }
